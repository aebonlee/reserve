...
import type { LectureRequest } from '../../types';

interface LectureRequestCardProps {
  request: LectureRequest;
  onClick?: () => void;
}

const LectureRequestCard = ({ request, onClick }: LectureRequestCardProps): React.ReactElement => {
