...
const Login = (): React.ReactElement | null => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'kakao'): Promise<void> => {
    setError('');
    try {
          ...
          {step === 'method' ? (
            <>
              <div className="auth-methods">
                <button className="auth-method-btn google" onClick={() => void handleSocialLogin('google')}>
                ...
                <button className="auth-method-btn kakao" onClick={() => void handleSocialLogin('kakao')}>
                  <svg viewBox="0 0 24 24" width="20" height="20">
            ...
            <>
              <form onSubmit={(e) => void handleEmailLogin(e)} className="auth-email-form">
